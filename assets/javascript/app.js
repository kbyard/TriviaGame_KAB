...
function initGame(){
	// display intro
	$("#qText").html('When you play the [Trivia] Game of Thrones, you win or you die! Some of these questions are quite difficult, but you will have only 10 seconds to answer. Good luck!<button id="startGame">Valar Morghulis</button>');
	$("#result").hide();
	$("#choices").hide();
	$("#choices li").empty();
	$(".scoreboard").empty();
...
function gameOver(){
	$("body").css("background-image", 'url("assets/images/background_body.jpg")');
